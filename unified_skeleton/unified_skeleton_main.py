...
print(f'Segment Connections: {skeleton.segments.segment_connections}') #segment connections
print(f"Proximal marker for left upper arm: {skeleton.segments.segment_connections['left_upper_arm'].proximal}") #proximal and distal markers for a segment
