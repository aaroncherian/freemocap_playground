...
class COM_plot_creator:
    ...
    def __init__(self,freemocap_session_path,freemocap_plotting_data,qualisys_plotting_data,output_video_fps, video_frames_to_plot,stance):
        
        self.azimuth = -70
        self.stance = stance
        self.num_frame_range = freemocap_plotting_data.num_frame_range

        self.run(freemocap_session_path,freemocap_plotting_data,qualisys_plotting_data,output_video_fps,video_frames_to_plot)


        f = 2
    def run(self,freemocap_session_path,freemocap_plotting_data,qualisys_plotting_data,output_video_fps,video_frames_to_plot):
        ...
        self.qualisys_plotting_data = qualisys_plotting_data
        ...
        ani.save(freemocap_session_path/'qualysis_{}.mp4'.format(self.stance), writer=writervideo)
    ...
    def animate(self,frame,video_frames_to_plot):
        ...
        qualisys_hip_connection_x,qualisys_hip_connection_y,qualisys_hip_connection_z = self.create_segment_connection(self.qualisys_plotting_data.skel_connections_XYZ_data,frame,'thigh')
        qualisys_shoulder_connection_x,qualisys_shoulder_connection_y,qualisys_shoulder_connection_z = self.create_segment_connection(self.qualisys_plotting_data.skel_connections_XYZ_data,frame,'upper_arm')

        self.plot_skeleton_bones(frame,ax_3d,ax_2d,self.qualisys_plotting_data.skel_connections_XYZ_data, color_str  = 'grey', alpha_val_3d=.5, alpha_val_2d=.2)
        ...
        self.plot_3d_line(qualisys_hip_connection_x,qualisys_hip_connection_y,qualisys_hip_connection_z,ax_3d,alpha_val = .5)
        self.plot_3d_line(qualisys_shoulder_connection_x,qualisys_shoulder_connection_y,qualisys_shoulder_connection_z,ax_3d,alpha_val = .5)
        ...
        ax_3d.scatter(self.qualisys_plotting_data.skeleton_XYZ_data[frame,:,0],self.qualisys_plotting_data.skeleton_XYZ_data[frame,:,1],self.qualisys_plotting_data.skeleton_XYZ_data[frame,:,2],color = 'grey', alpha= .5, label = 'Qualisys')
        ...
        self.plot_3d_segment_and_total_body_COM(frame,ax_3d,self.qualisys_plotting_data.segment_COM_data,self.qualisys_plotting_data.total_body_COM_data,alpha_val = .5)
        ...
        #ax_2d.plot(-1*np.array(shoulder_connection_x),-1*np.array(shoulder_connection_y),color = 'grey', alpha = .4)
        #ax_2d.plot(-1*np.array(hip_connection_x),-1*np.array(hip_connection_y),color = 'grey', alpha = .4)
        tail_length = 120
        ...
        self.plot_2d_line(qualisys_hip_connection_x,qualisys_hip_connection_y,ax_2d,alpha_val = .2)
        self.plot_2d_line(qualisys_shoulder_connection_x,qualisys_shoulder_connection_y,ax_2d,alpha_val = .2)
        ...
        if plot_fade_frame < 0:
            ...
            ax_2d.plot(self.qualisys_plotting_data.total_body_COM_data[0:frame,0],self.qualisys_plotting_data.total_body_COM_data[0:frame,1],color = 'grey',alpha = .4)
            #ax_2d.plot(-1*self.this_range_totalCOM_frame_XYZ[0:frame,0],-1*self.this_range_totalCOM_frame_XYZ[0:frame,1], color = 'grey')
        else:
            ...
            ax_2d.plot(self.qualisys_plotting_data.total_body_COM_data[plot_fade_frame:frame,0],self.qualisys_plotting_data.total_body_COM_data[plot_fade_frame:frame,1],color = 'grey',alpha = .4)
        ...
        ax_2d.plot(self.qualisys_plotting_data.total_body_COM_data[frame,0],self.qualisys_plotting_data.total_body_COM_data[frame,1],marker = '*', color = 'magenta', markeredgecolor = 'purple', ms = 8, alpha = .5)


        if self.stance == 'natural':
            self.plot_BOS_bounds(frame,ax_2d,self.freemocap_plotting_data,1,.3)
            self.plot_BOS_bounds(frame,ax_2d,self.qualisys_plotting_data,1,.1)
            ...
            self.plot_future_COM_and_lateral_BOS_positions(ax_1d_lat,self.qualisys_plotting_data, alpha_val=.5)
            ...
            self.plot_current_COM_and_lateral_BOS_positions(frame,ax_1d_lat,self.qualisys_plotting_data,alpha_val=.2)

            self.plot_future_COM_and_antpos_BOS_positions(ax_1d_ap,self.freemocap_plotting_data)
            self.plot_future_COM_and_antpos_BOS_positions(ax_1d_ap,self.qualisys_plotting_data, alpha_val=.5)
            ...
            self.plot_current_COM_and_antpos_BOS_positions(frame,ax_1d_ap,self.qualisys_plotting_data,alpha_val=.2)
        
        if self.stance == 'right_leg':
            self.plot_BOS_right_leg_bound(frame,ax_2d,self.freemocap_plotting_data,1,.5)
            self.plot_BOS_right_leg_bound(frame,ax_2d,self.qualisys_plotting_data,1,.3)
        ...
        #ax_3d.legend(*d,bbox_to_anchor=(.24, -0.53))  
        #ax_3d.legend(bbox_to_anchor=(.24, -0.53))
        #ax_2d.legend(fontsize = 10, bbox_to_anchor=(1.15, -.5),ncol = 2)
...
if __name__ == '__main__':
    ...
    if stance == 'natural':
        ...
        # qualisys_num_frame_range = range(5030-750,7000-750)

        #mediapipe_num_frame_range = range(5423,6653) #for webcam natural
        #qualisys_num_frame_range = range(54230-760,66530-760,10)



        #mediapipe_num_frame_range = range(5423,5523) #for webcam natural
        #qualisys_num_frame_range = range(54230-760,55230-760,10)

        #mediapipe_num_frame_range = range(6000,6600)
        #qualisys_num_frame_range = range(40000,46000,10)
        #mediapipe_num_frame_range = range(1461,2461)
        #qualisys_num_frame_range = range(3000,13000,10)

        #num_frame_range = range(4500,6800)
        
        mediapipe_num_frame_range = range(473,1373)
        qualisys_num_frame_range = range(4730-760,13730-760,10)
    ...
    COM_plot = COM_plot_creator(freemocap_session_path,mediapipe_data_to_plot,qualisys_data_to_plot,30,video_frames_to_plot, stance)
    f=2
