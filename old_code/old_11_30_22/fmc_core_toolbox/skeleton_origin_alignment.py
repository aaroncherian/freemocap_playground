...
if __name__ == '__main__':
    ...
    origin_aligned_skeleton_data, y_aligned_skeleton_data,foot_translated_skeleton_data = align_skeleton_with_origin(skeleton_data,skeleton_indices, good_frame)

    if debug:
        plot_all_skeletons(skeleton_data,foot_translated_skeleton_data,y_aligned_skeleton_data,origin_aligned_skeleton_data,mediapipe_indices,good_frame)
