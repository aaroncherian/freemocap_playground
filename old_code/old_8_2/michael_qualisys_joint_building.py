...
qualisys_data = np.load(freemocap_data_array_path/'qualisys_skel_3d.npy')
...
left_foot_XYZ = np.mean([left_medfoot_XYZ,left_latfoot_XYZ],axis=0)
...
left_hip_XYZ = np.mean([left_asis_XYZ,left_psis_XYZ],axis=0)
right_hip_XYZ = np.mean([right_asis_XYZ,right_psis_XYZ],axis=0)
#left_hip_XYZ = 
#right_hip_XYZ = 
