...
from PyQt6.QtWidgets import QMainWindow, QSlider, QGridLayout, QWidget,QLabel, QFileDialog,QPushButton, QFormLayout, QVBoxLayout
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        main_layout.addWidget(self.fig,3,0)

        
        self.videoDisplayWidget = VideoDisplayWidget(self)
        main_layout.addWidget(self.videoDisplayWidget,3,1)
