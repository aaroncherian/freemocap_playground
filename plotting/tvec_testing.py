...
rvec_0 = np.array([ 2.1833511025110073, 0.8084631416212714, 1.102307351152838,])
R0,_ = cv2.Rodrigues(rvec_0)
tvec_0 = np.array([ 77.48823949696346, 877.9975906024199, 1836.4059425400828,])

rvec_1 = np.array([ 0.4095473507772628, 1.0448313442196369, 1.2160979734246244,])
R1, _ = cv2.Rodrigues(rvec_1)
tvec_1 = np.array([ 263.97396399481045, 643.3212519912914, 2452.045091659231,])

rvec_2 = np.array([ 1.1170066185990999, 1.1962989231113912, 1.2948332888997174,])
R2,_ = cv2.Rodrigues(rvec_2)
tvec_2 = np.array([ 57.279368360038006, 934.3507808101444, 2103.4469012531454,])
