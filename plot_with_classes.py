...
class skeleton_COM_Plot:
    def __init__(self, freemocap_validation_data_path, sessionID, num_frame_range, camera_fps, output_video_fps, tail_length, static_plot = False):
    ...
    def create_paths_to_data_files(self, validation_data_path, sessionID):
        ...
        totalCOM_data_path = this_freemocap_data_path / 'openPose_totalBodyCOM_frame_XYZ.npy'
        segmentedCOM_data_path = this_freemocap_data_path / 'openPose_segmentedCOM_frame_joint_XYZ.npy'
        ...
        mediapipeSkeleton_file_name = this_freemocap_data_path/'openPose_Skelcoordinates_frame_segment_joint_XYZ.pkl'
    ...
    def animate2(self,frame,video_frames_to_plot):
            ...
            ax.scatter(this_frame_total_COM_x,this_frame_total_COM_y,0, color = 'magenta', marker = '*', s = 50, edgecolor = 'purple', alpha = .5)
            ...
            yy = np.linspace(self.my-self.ax_range,self.my+self.ax_range,len(num_frame_range)-1)
            distance_raised = 1600
            ax.plot(yy,-1*this_range_totalCOM_frame_XYZ[:,1]+distance_raised,self.mx-self.ax_range,zdir ='x', color = 'grey',alpha = .5)
            ax.plot([yy[frame],yy[frame]],[front_foot_avg_y[frame]+distance_raised,back_foot_avg_y[frame]+distance_raised], self.mx-self.ax_range,zdir ='x', color = 'black',alpha = .7)
            ax.plot(yy, front_foot_avg_y[:]+distance_raised, self.mx-self.ax_range,zdir ='x', color = 'forestgreen',alpha = .5)
            ax.plot(yy, back_foot_avg_y[:]+distance_raised, self.mx-self.ax_range,zdir ='x', color = 'coral',alpha = .5)

            
            ax.plot(yy[0:frame],-1*this_range_totalCOM_frame_XYZ[0:frame,1]+distance_raised,self.mx-self.ax_range,zdir ='x', color = 'black',alpha = .8)
            ax.scatter(yy[frame],-1*this_range_totalCOM_frame_XYZ[frame,1]+distance_raised,self.mx-self.ax_range,zdir ='x', color = 'magenta',alpha = .8,marker = '*', edgecolor = 'purple', s = 40)

            
            xx = np.linspace(self.mx-self.ax_range,self.mx+self.ax_range,len(num_frame_range)-1)
            ax.plot(xx,-1*this_range_totalCOM_frame_XYZ[:,0]+distance_raised,self.my+self.ax_range,zdir ='y', color = 'grey',alpha = .5)
            ax.plot([xx[frame],xx[frame]],[left_foot_avg_x[frame]+distance_raised,right_foot_avg_x[frame]+distance_raised], self.my+self.ax_range,zdir ='y', color = 'black',alpha = .7)
            ax.plot(xx, left_foot_avg_x[:]+distance_raised, self.my+self.ax_range,zdir ='y', color = 'blue',alpha = .5)
            ax.plot(xx, right_foot_avg_x[:]+distance_raised, self.my+self.ax_range,zdir ='y', color = 'red',alpha = .5)

            ax.plot(xx[0:frame],-1*this_range_totalCOM_frame_XYZ[0:frame,0]+distance_raised,self.my+self.ax_range,zdir ='y', color = 'black',alpha = .8)
            ax.scatter(xx[frame],-1*this_range_totalCOM_frame_XYZ[frame,0]+distance_raised,self.my+self.ax_range,zdir ='y', color = 'magenta',alpha = .8,marker = '*', edgecolor = 'purple', s = 40)



            
            #ax.plot(xx[0:frame],-1*this_range_totalCOM_frame_XYZ[0:frame,0]+distance_raised,self.mx-self.ax_range,zdir ='y', color = 'black',alpha = .8)
            #ax.scatter(xx[frame],-1*this_range_totalCOM_frame_XYZ[frame,0]+distance_raised,self.mx-self.ax_range,zdir ='y', color = 'magenta',alpha = .8,marker = '*', edgecolor = 'purple', s = 40)
    ...
    def generate_plot(self,this_range_mp_pose_XYZ,this_range_mp_skeleton_segment_XYZ,this_range_segmentCOM_fr_joint_XYZ,this_range_totalCOM_frame_XYZ, video_frames_to_plot):
        ...
        ani.save(self.this_freemocap_session_path/'mediapipe_testing.mp4', writer=writervideo)
        ...
        # np.save(self.this_freemocap_session_path/'CSV_medial_max.npy',xself.medial_bound_max_array)
