...
class animateSkeleton:
    ...
    def animate(self,frame,video_frames_to_plot):
        ...
        ax5.cla()
        #ax2.clear()
        ax2.set_xlim([self.mx_com-self.ax_com_range, self.mx_com+self.ax_range])
        ax2.set_ylim([self.my_com-self.ax_com_range, self.my_com+self.ax_range])
        ...
        ax5.set_ylim([self.mx-200, self.mx+200])
        ax5.set_xlim([self.num_frame_range[0],self.num_frame_range[-1]])
        ...
        ax2.plot(self.this_range_totalCOM_frame_XYZ[0:frame,0],self.this_range_totalCOM_frame_XYZ[0:frame,1], color = 'black')
        ...
        ax5.set_ylabel('Horizontal Position (units)')
        ax5.plot(self.num_frame_range[frame],total_COM_x, 'o', color = 'black', ms = 1.5)
        ax5.plot(self.num_frame_range[0:frame],self.this_range_totalCOM_frame_XYZ[0:frame,0])
        #ax4.plot()
    ...
    def generate_plot(self,this_range_mp_pose_XYZ,this_range_mp_skeleton_segment_XYZ,this_range_segmentCOM_fr_joint_XYZ,this_range_totalCOM_frame_XYZ, video_frames_to_plot):
        ...
        # plt.tight_layout()
        ax = figure.add_subplot(322, projection = '3d')
        ax2 = figure.add_subplot(324)
        ax3 = figure.add_subplot(321)
        ax4 = figure.add_subplot(323)
        ...
        ani.save(self.this_freemocap_session_path/'ytest_with_trajectory_rotated_2.mp4', writer=writervideo)
