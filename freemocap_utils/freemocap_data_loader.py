...
from freemocap_config.folder_directory import DATA_FOLDER_NAME, MEDIAPIPE_3D_BODY_FILE_NAME,TOTAL_BODY_CENTER_OF_MASS_NPY_FILE_NAME
...
class FreeMoCapDataLoader():
    ...
    def load_total_body_COM_data(self):
        self.path_to_total_body_COM_data = self.path_to_session_folder/'output_data'/'center_of_mass'/'total_body_center_of_mass_xyz.npy'
