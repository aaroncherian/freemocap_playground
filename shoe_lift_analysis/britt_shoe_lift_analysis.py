...
def plot_leg_markers(left_session_step_stats: dict, right_session_step_stats: dict, dimension_to_plot: int, labels: list):
    ...
    ax1.set_title('Left Shoulder, Hip, Knee & Ankle Height')
    ax2.set_title('Right Shoulder, Hip, Knee & Ankle Height')
...
#plot heel strikes and toe off for the right foot
...
#plot heel strikes and toe off for the left foot
