...
filtered_qualisys_data = butterworth_filter_data(interpolated_qualisys_data,6,300,4)
...
np.save(path_to_qualisys_session_folder/'DataArrays'/'qualisys_marker_data_29Hz.npy', resampled_qualisys_data)
